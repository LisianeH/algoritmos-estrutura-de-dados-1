...
class ProdutoApp( QWidget ):
    ...
    def initUI( self ):
        ...
        layout.addWidget( QLabel( "Qual tipo de Produto:" ) )
        layout.addWidget( self.tipo_combo )

        layout.addWidget( QLabel( "Digite o modelo:" ) )
        layout.addWidget( self.modelo_input )

        layout.addWidget( QLabel( "Digite a cor:" ) )
        layout.addWidget( self.cor_input )

        layout.addWidget( QLabel( "Digite o preço:" ) )
        layout.addWidget( self.preco_input )

        layout.addWidget( QLabel( "Digite a categoria:" ) )
